...
class CreateEduTeacherVersionPublishTable extends Migration {
	...
	public function up()
	{
		Schema::create('edu_teacher_version_publish', function(Blueprint $table)
		{
	...
	{
		Schema::drop('edu_teacher_version_publish');
	}
