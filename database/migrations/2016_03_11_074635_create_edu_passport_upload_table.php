...
class CreateEduPassportUploadTable extends Migration {
	...
	public function up()
	{
		Schema::create('edu_passport_upload', function(Blueprint $table)
		{
			$table->increments('id');
			$table->char('user_id', 18)->default(0);
			$table->string('file_key', 40)->default('');
	...
	{
		Schema::drop('edu_passport_upload');
	}
