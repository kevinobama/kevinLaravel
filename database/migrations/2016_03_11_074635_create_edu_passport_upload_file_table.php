...
class CreateEduPassportUploadFileTable extends Migration {
	...
	public function up()
	{
		Schema::create('edu_passport_upload_file', function(Blueprint $table)
		{
			$table->increments('id');
	...
	{
		Schema::drop('edu_passport_upload_file');
	}
