...
class CreateEduPassportStudentFieldTable extends Migration {
	...
	public function up()
	{
		Schema::create('edu_passport_student_field', function(Blueprint $table)
		{
	...
	{
		Schema::drop('edu_passport_student_field');
	}
