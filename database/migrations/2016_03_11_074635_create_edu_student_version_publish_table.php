...
class CreateEduStudentVersionPublishTable extends Migration {
	...
	public function up()
	{
		Schema::create('edu_student_version_publish', function(Blueprint $table)
		{
	...
	{
		Schema::drop('edu_student_version_publish');
	}
