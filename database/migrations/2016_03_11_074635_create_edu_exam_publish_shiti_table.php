...
class CreateEduExamPublishShitiTable extends Migration {
	...
	public function up()
	{
		Schema::create('edu_exam_publish_shiti', function(Blueprint $table)
		{
			$table->increments('id');
			$table->integer('shiti_id')->unsigned()->default(0);
			...
			$table->text('images_h', 65535)->nullable();
	...
	{
		Schema::drop('edu_exam_publish_shiti');
	}
